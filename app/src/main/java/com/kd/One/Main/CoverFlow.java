...
public class CoverFlow extends Gallery{
     ...
     * @param maxZoom the mMaxZoom to set
     */
    public void setOnFilingVal(double onFiling) {
        mOnFiling = onFiling;
    }
    ...
    private void transformImageBitmap(ImageView child, Transformation t, int rotationAngle) {
        ...
        float x = (float) ((-rotation*0.2) - 7);
        float alpha = (float) (255-(rotation*5.5));

        //child.setAlpha((int) alpha);
        mCamera.rotateX(x);
